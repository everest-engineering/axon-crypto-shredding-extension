...
@AllArgsConstructor
@Builder
public class EventWithMismatchedMultipleEncryptionKeyIdentifierTags {

    public static EventWithMismatchedMultipleEncryptionKeyIdentifierTags createTestInstance() {
        return EventWithMismatchedMultipleEncryptionKeyIdentifierTags.builder()
    ...
    @EncryptedField(tag = "oopsie-mismatched-tag")
